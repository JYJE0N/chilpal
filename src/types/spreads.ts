...
export const SPREADS: SpreadDefinition[] = [
  ...
  },
  {
    ...
    recommendedFor: ["인간 관계", "우정", "가족 관계", "업무 관계"],
    positions: [
      {
        id: 1,
        name: "당신",
        description: "관계에서 당신의 입장",
        x: 25,
        y: 30,
      },
      {
